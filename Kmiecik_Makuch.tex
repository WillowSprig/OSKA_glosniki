...
\section{Analiza wyników}
	...
	Otrzymane charakterystyki kierunkowości dla głośnika niskotonowego przedstawiono na rysunku~\ref{r:kierunkowosc_L}, a~dla wysokotonowego na rysunku~\ref{r:kierunkowosc_H}. 
		...
		\begin{figure}[!ht]
			...
			\begin{subfigure}[b]{.46\textwidth}
				...
				\label{r:C_pion}
			\end{subfigure}
			\caption{Charakterystyki kierunkowości głośnika wysokotonowego w~obudowie}
			\label{r:kierunkowosc_H}
		\end{figure}
		
		Z~kolei głośnik wysokotonowy charakteryzuje się bardzo równomierną charakterystyką kierunkową w~płaszczyźnie poziomej, co związane jest z~kształtem wylotu falowodu, wygiętego na boki.
