...
% 	\end{table}
	...
	W~celu sprawdzenia wpływu modyfikacji obudowy na charakterystyki impedancji wykonano pomiar obudowy w~wariancie „podstawowym” (opisanym w~części~\ref{ss:opis}) oraz z~zaślepionymi otworami. Wyniki przedstawiono na rysunku~\ref{r:obudowa_otwory}. 
