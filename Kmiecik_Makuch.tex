	...
	\subsection{Pomiary impedancji}
		...
		\begin{table}[!ht]
			...
			\begin{tabular}{|c|c|c|c|c|c|c|}
				\hline
				\multirow{2}{*}{\textbf{Parametr}} & \multirow{2}{*}{\makecell{\textbf{Karta}\\ \textbf{katalogowa}}} & \multicolumn{3}{c|}{\textbf{Pomiar fabryczny}} & \textbf{Etap 1} & \textbf{Etap 2}\\\cline{3-7}
				& & \textbf{Masa \SI{5}{\gram}} &\textbf{Masa \SI{10}{\gram}} & \makecell{\textbf{Obudowa}\\ \textbf{\SI{80}{\litre}}} & \multicolumn{2}{c|}{\textbf{Masa \SI{10}{\gram}}}\\
				\hline
				$F_s$ [\si{\Hz}] & \num{47,0} & \num{} & \num{71,5} & \num{} & \num{57,0} & \num{50,7} \\\hline
				$Z_{max}$ [\si{\ohm}] & \num{}& \num{} & \num{54,2}  & \num{}& \num{55,7} & \num{64,0} \\\hline
				$R_e$ [\si{\ohm}] & \num{6,1}& \num{}  & \num{10,4} & \num{} & \num{10,0} & \num{10,2} \\\hline
