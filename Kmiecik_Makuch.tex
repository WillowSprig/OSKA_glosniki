...
% 		\end{picture}
	...
	W celu weryfikacji skuteczności podawanej przez producenta wykonano pomiar poziomu dźwięku $L_{eq}$ w~odległości \SI{2}{\metre}. Do pomiarów wykorzystano analizator SVAN 912E; głośnik pobudzano szumem różowym w~paśmie \range{50}{5000}~\si{\hertz} o~wartości skutecznej \SI{1}{\watt}. 
