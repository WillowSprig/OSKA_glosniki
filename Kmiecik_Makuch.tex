...
% 	\end{table}
	...
	W~wynikach wszystkich pomiarów wykonanych w~odgrodzie widoczny jest jej wpływ -- charakterystyka załamuje się w~okolicach częstotliwości \SI{54}{\hertz} (rysunki~\ref{r:metody}--\ref{r:2glosniki}). Prawdopodobnie związane jest to z~rezonansem płyty, występującym ze względu na jej skończone wymiary.
...
% 		\end{picture}
	...
	Z~kolei głośnik wysokotonowy charakteryzuje się bardzo równomierną charakterystyką kierunkową w~płaszczyźnie poziomej (rysunek~\ref{r:H_poziom}) powyżej częstotliwości \SI{1100}{Hz}. W~płaszczyźnie pionowej występuje nierównomierność charakterystyki w~zakresie \range{2000}{4000}~\si{\hertz}.
