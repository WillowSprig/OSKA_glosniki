...
\section{Metodyka pomiarów}
	...
	\subsection{Metodyka podstawowa}\label{ss:metodyka}
		...
		\subsubsection{Drgania obudowy}
			...
			Sygnałem pomiarowym był szum różowy, rejestrowano jednocześnie przebieg drgań wibrometrem oraz sygnał akustyczny mikrofonem umieszczonym blisko głośnika (rys.~\ref{r:zdjecie_wibro}). \color{red} \textbf{Czy na pewno tak, ew. podać odległości/odległości a jak pamiętamy?} \color{black} Wibrometr umieszczono poza przestrzenią komory celem zapewnienia stabilnego usadowienia wibrometru.
